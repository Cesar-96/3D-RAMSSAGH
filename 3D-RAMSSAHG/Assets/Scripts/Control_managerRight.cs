...
public class control_managerRight : MonoBehaviour
{
    // RAMSSAHG PIECES
    ...
    void Update()
    {
        ...
        Shoulder_left.localPosition = _BodyManager.GetBodyJointPosModded(Windows.Kinect.JointType.ShoulderRight);
        Elbow_left.localPosition = _BodyManager.GetBodyJointPosModded(Windows.Kinect.JointType.ElbowRight);
        Wrist_left.localPosition = _BodyManager.GetBodyJointPosModded(Windows.Kinect.JointType.WristRight);
        Hand_left.localPosition = _BodyManager.GetBodyJointPosModded(Windows.Kinect.JointType.HandRight);
        Hand_tipleft.localPosition = _BodyManager.GetBodyJointPosModded(Windows.Kinect.JointType.HandTipRight);
        Thumb_left.localPosition = _BodyManager.GetBodyJointPosModded(Windows.Kinect.JointType.ThumbRight);
        ...
        if (Input.GetKey(KeyCode.W))
        {
            ...
            // Actualiza la posici�n/rotaci�n del brazo hacia adelante
            // Por ejemplo, podr�as modificar la posici�n de la parte del brazo correspondiente aqu�
            // Ejemplo ficticio:
